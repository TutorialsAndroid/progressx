...
Starting from the latest versions of **ProgressX**, this library is built with the latest Android SDK.
...
```txt
Dependency 'io.github.tutorialsandroid:progressx:7.0.5' requires libraries and applications
...
This happens because the latest version of ProgressX is compiled with **Android API 37**.
